...
def mi2(x, y, bins):
    ...
    counts_xy = np.histogram2d(x, y, bins=bins, range=[[0, 311335], [0, 311335]])[0]
    counts_x  = np.histogram(  x,    bins=bins, range=[0, 311335])[0]
    counts_y  = np.histogram(  y,    bins=bins, range=[0, 311335])[0]
